...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="☁️ 𝙼𝚞𝚂𝚒𝙲 ☁️", url=f"http://t.me/Sixty_music_bot"),
    ],
]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            url="https://github.com/MayankRai30",
                        ),
                    ],
                    [
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://t.me/FLAME_MAINCHATS)
